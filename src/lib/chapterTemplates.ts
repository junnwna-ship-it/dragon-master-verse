  ...
  nodes: [
    {
      ...
      speaker: "Narrator",
      body_text:
        "Dawn breaks over your family's onion field. As you work, a soldier of King Roland rides up, reads your name from a scroll, and announces that the Dragon Stone has chosen you. You must leave for the castle to train as a Dragon Master.",
    ...
    },
    {
      ...
      speaker: "Narrator",
      body_text:
        "The castle gates groan open. Inside the courtyard a colossal red dragon — Vulcan — rears up and unleashes a torrent of flame. Stone blackens. Guards scatter. The air itself burns.",
      background_image_url: null,
      is_start: false,
      state_changes: {},
      rewards: {},
    ...
    },
    {
      ...
      title: "롤랜드 왕의 방문",
      speaker: null,
      body_text: "롤랜드 왕이 방문하여 드래곤 군대를 기대하지만, 플레이어와 웜을 보고 실망합니다.",
      background_image_url: null,
      is_start: false,
      state_changes: {},
      rewards: {},
    ...
    },
    {
      ...
      speaker: "Worm",
      body_text:
        'Blue light pulses in the dark. The worm\'s voice arrives without sound, straight inside your head: "Do not enter that tunnel. What waits there does not forgive."',
      background_image_url: null,
      is_start: false,
      state_changes: {},
      rewards: {},
    ...
    },
    {
      ...
      title: "스톤의 공명",
      speaker: null,
      body_text: "플레이어의 드래곤 스톤과 웜의 눈이 초록색으로 빛나며 강하게 공명합니다.",
      background_image_url: null,
      is_start: false,
      state_changes: {},
      rewards: {},
    ...
    },
    {
      ...
      speaker: "Narrator",
      body_text:
        "The tunnel collapses. Then the worm's eyes flare, and the fallen boulders shudder, crack, and dissolve into drifting dust. Earth magic. The power of a focused mind.",
      background_image_url: null,
      is_start: false,
      state_changes: {},
      rewards: {},
    ...
    },
    {
      ...
      speaker: "Narrator",
      body_text:
        'Griffith\'s torch finds you in the dark. He studies the worm for a long moment, then nods. "So it is true. You may be a master after all. Good — because something worse than Vulcan is stirring."',
      background_image_url: null,
      is_start: false,
      state_changes: {},
      rewards: {},
