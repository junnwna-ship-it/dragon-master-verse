...
const dragon = (id: number, uuid?: string): Dragon => ({ id, uuid, name: "루미", element: "Earth", hp: 1750, maxHp: 1750, mp: 900, atk: 1200, def: 1550 });
...
describe("lobby roster merge", () => {
  ...
  it("replaces old legacy scans instead of accumulating duplicates", () => {
    expect(mergeScannedDragons([dragon(1), dragon(1000)], [dragon(1000), dragon(1001)])).toHaveLength(3);
  });
